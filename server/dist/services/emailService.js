...
exports.sendQuoteApprovalEmail = sendQuoteApprovalEmail;
exports.sendQuoteSubmissionEmails = sendQuoteSubmissionEmails;
exports.sendQuoteStatusUpdateEmail = sendQuoteStatusUpdateEmail;
/**
 ...
 */
async function sendQuoteApprovalEmail(quote, pdfHtml) {
...
async function sendQuoteSubmissionEmails(quote) {
...
async function sendQuoteStatusUpdateEmail(quote, payload) {
    const dashboardUrl = process.env.FRONTEND_URL
