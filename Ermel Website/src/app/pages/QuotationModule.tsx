            ...
            <div>
              ...
              <div className="flex items-center gap-2 mb-4">
                ...
                {(['cm', 'm', 'ft'] as MeasurementUnit[]).map((u) => (
                  <button key={u} onClick={() => handleUnitChange(u)} className="min-h-[40px] min-w-[48px] px-4 py-2 rounded-lg transition-all" style={{ fontFamily: 'var(--font-heading)', fontSize: '14px', fontWeight: measureUnit === u ? 700 : 500, letterSpacing: '0.06em', textTransform: 'uppercase', backgroundColor: measureUnit === u ? '#15263c' : '#f0f2f5', color: measureUnit === u ? 'white' : '#54667d', border: measureUnit === u ? '2px solid #15263c' : '2px solid #d9d9d9', cursor: 'pointer' }}>
                    {u}
                  </button>
                ))}
              </div>
              ...
              <div className="lg:col-span-2">
                ...
                <div className="rounded-xl p-6 mb-4" style={{ background: 'linear-gradient(135deg, #15263c, #1e3655)', borderRadius: '8px' }}>
                  ...
                  <div className="mt-3 px-3 py-1.5 rounded-lg inline-block" style={{ backgroundColor: 'rgba(255,165,0,0.2)', border: '1px solid rgba(255,165,0,0.4)' }}>
                    <span style={{ color: '#ffcc00', fontSize: '11px', fontFamily: 'var(--font-heading)', letterSpacing: '0.08em' }}>⚠ SUBJECT TO ADMIN APPROVAL</span>
                  </div>
                </div>
